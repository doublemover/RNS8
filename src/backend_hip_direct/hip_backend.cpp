...
extern "C" int rns8_hip_direct_ring_gemv_n1_i8_grouped_prefix_device(
    const int8_t* d_a,
    const int8_t* d_b,
    int8_t* d_c,
    int m,
...
extern "C" int rns8_hip_direct_ring_gemm_i64_native_a_resident_b_prefix9_colpair_device(
    const int64_t* d_a,
    const int8_t* d_b,
    int8_t* d_c,
    int m,
