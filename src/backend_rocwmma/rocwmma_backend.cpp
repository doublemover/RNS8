...
// Event recording uses run_timed_device_code in the dispatch functions below.
// The rocWMMA backend is a separate build target that cannot reference
// Direct HIP internal helpers (timed_hip_operation).
