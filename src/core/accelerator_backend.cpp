...
constexpr accelerator_backend_descriptor kCkDescriptor{
    ...
    "Composable Kernel",
    "RNS8_ENABLE_CK",
    "ck_grouped_fused_int8_i32_residue_pending_v1",
    "fused_i32_to_centered_residue_pending",
    "resident_device_buffers_with_ck_workspace_pending",
    "not_validated",
    "not_implemented_evidence_only",
    "Reserved grouped/fused CK accelerator. Dependency probes are evidence only; enable flag stays fail-fast until "
    "compiled kernels, exact differentials, ISA/readiness evidence, and benchmark captures exist.",
    1,
    1,
    1,
    0,
...
constexpr accelerator_backend_descriptor kWmmaDescriptor{
    ...
    "gfx1100_wmma_builtin_fused_residue_pending_v1",
    "fused_matrix_engine_residue_pending",
    "resident_device_buffers_with_wmma_workspace_pending",
    "not_validated",
    "not_implemented_evidence_only",
    "Reserved gfx1100 rocWMMA/AMDGPU builtin hot-kernel backend. Dependency probes are evidence only; enable flags "
    "stay fail-fast until exact kernels, ISA gates, and benchmark captures exist.",
    1,
    1,
    1,
    0,
