...
struct rns8_plan {
  ...
  uint64_t backend_accumulator_k_block_cap = 0;
  uint64_t backend_accumulator_modulus = 0;
  uint64_t backend_accumulator_max_lhs_abs = 0;
  uint64_t backend_accumulator_max_rhs_abs = 0;
  uint64_t backend_accumulator_max_product = 0;
  uint32_t backend_accumulator_uses_int32_inner_product = 0;
  uint32_t backend_accumulator_safe_for_k_block = 0;
  std::string backend_accumulator_input_domain;
  std::string backend_accumulator_signedness;
  std::string backend_accumulator_type;
  std::string backend_accumulator_modulus_policy;
...
struct rns8_workspace {
  ...
  int64_t hipblaslt_b_prepack_k = 0;
  int64_t hipblaslt_b_prepack_n = 0;
  int64_t hipblaslt_b_prepack_ldb = 0;
  uint32_t hipblaslt_b_prepack_prefix = 0;
  int hipblaslt_b_prepack_device_id = -1;
  bool hipblaslt_b_prepack_current = false;
...
struct rns8_prepack_cache {
  ...
  uint32_t prefix = 0;
  uint32_t finite_modulus = 0;
  uint64_t prefix_schedule_fingerprint = 0;
  ...
  std::string prepack_kernel_variant;
