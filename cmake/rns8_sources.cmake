...
if(RNS8_ENABLE_HIP)
  ...
  if(RNS8_ENABLE_AMDGPU_BUILTINS)
    ...
    message(STATUS "RNS8 AMDGPU builtin candidate evidence: target-specific matrix-core HIP kernels scheduled for compilation")
  ...
  if(RNS8_ENABLE_CK)
    ...
    set(
      ...
      "-DRNS8_CK_SHAPE_ALIGNMENT=${RNS8_CK_SHAPE_ALIGNMENT}"
    )
    if(MSVC)
      list(APPEND RNS8_HIP_SOURCE_COMPILE_OPTIONS "-D_CRT_SECURE_NO_WARNINGS")
    endif()
    rns8_compile_hip_source(
  ...
  if(RNS8_ENABLE_ROCWMMA)
    ...
    if(RNS8_AMDGPU_TARGETS)
      ...
      if(RNS8_ROCWMMA_ACTIVE_TARGET MATCHES "^gfx9")
        set(RNS8_ROCWMMA_WAVE_THREADS 64)
      endif()
    endif()
