    ...
    return {
        ...
        "many-small": [
            ...
            ScenarioItem(
                ...
                "exact-wide-unsigned",
                many_small_64,
                "many-small exact-wide unsigned proxy with fixed limb export",
                "exact_wide_unsigned_limbs",
                "adds the unsigned exact-wide independent baseline needed to classify grouped-dispatch unsigned captures",
                backends=EXACT_WIDE_BACKENDS,
                exact_wide_limb_counts=(4,),
                metadata={
                    "evidence_role": "proxy_single_shape_repeat",
            ...
            ScenarioItem(
                ...
                "exact-wide-unsigned",
                many_small_64,
                "many-small host API batch exact-wide unsigned candidate",
                "exact_wide_unsigned_limbs",
                "pairs the existing grouped unsigned smoke path with a same-backend host-batch baseline",
                backends=EXACT_WIDE_BACKENDS,
                exact_wide_limb_counts=(4,),
                host_api_batch_size=32,
                metadata={
