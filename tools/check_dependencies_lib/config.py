...
LINUX_ROCM_REQUIRED_COMMANDS = ["hipcc", "rocminfo"]
LINUX_ROCM_DIAGNOSTIC_COMMANDS = ["hipconfig"]
LINUX_ROCM_COMMANDS = LINUX_ROCM_REQUIRED_COMMANDS + LINUX_ROCM_DIAGNOSTIC_COMMANDS
