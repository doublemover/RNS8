...
CONTRACT_KEYS = [
    ...
    "residue_count_policy.selected_prefix",
    ...
    "resident_lifetime.output_domain",
    "workspace_arena.enabled",
    "workspace_arena.stream_safety",
    "streaming_overlap.requested",
    "streaming_overlap.pipeline",
    "release_gate.name",
    "verification_amortization.policy",
...
BACKEND_EVIDENCE_KEYS = [
    ...
    "reuse_contract.operand_role",
    "reuse_contract.setup_scope",
    "reuse_contract.backend_fingerprint",
