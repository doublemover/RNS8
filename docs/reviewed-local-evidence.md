...
| 2026-06-06 | rank 47 Direct-HIP exact-wide tree/CRT default-route A/B | 20260606 | 1024 exact-wide signed, 4 limbs | Direct HIP | narrow tree-pair CRT export route: 14341 us median end-to-end vs fixed-prefix Garner export at 15032 us, 1.05x faster; export event median 1487.30 us vs 3027.44 us, 2.04x faster; selected export kernel `hip_direct_export_exact_wide_signed_tree_crt_limbs_device` | default-route captures under `temp/rank47-tree-crt-default-route-final-20260606/` compared against selector-review fixed-prefix captures under `temp/rank47-tree-crt-20260606/`; schema v4 valid; required GPU events available; CPU-reference/checksum comparison and `result_compare.py --allow-export-selector-diff` confirm matching shape, selected prefix, limb count, signedness, backend, target, and checksum | local Windows `gfx1100` Direct-HIP default-route evidence for signed prefix18, four-limb, large-output exports only; no README claim, installed cache entry, or Linux/CDNA claim |
| 2026-06-06 | rank 47 Direct-HIP exact-wide tree/CRT default-route A/B | 20260606 | 2048 exact-wide signed, 4 limbs | Direct HIP | narrow tree-pair CRT export route: 93263 us median end-to-end vs fixed-prefix Garner export at 99186 us, 1.06x faster; export event median 4953.46 us vs 10709.30 us, 2.16x faster; selected export kernel `hip_direct_export_exact_wide_signed_tree_crt_limbs_device` | default-route captures under `temp/rank47-tree-crt-default-route-final-20260606/` compared against selector-review fixed-prefix captures under `temp/rank47-tree-crt-followup-20260606/`; schema v4 valid; required GPU events available; `result_compare.py --allow-export-selector-diff` confirms matching shape, selected prefix, limb count, signedness, backend, target, and checksum compatibility | local Windows `gfx1100` Direct-HIP default-route evidence for signed prefix18, four-limb, large-output exports only; no README claim, installed cache entry, or Linux/CDNA claim |
| 2026-06-06 | rank 47 Direct-HIP exact-wide tree/CRT selector A/B | 20260606 | 1024 exact-wide unsigned, 4 limbs | Direct HIP | tree-pair CRT export event improves but end-to-end loses: 12639 us median end-to-end vs fixed-prefix Garner export at 12357 us; export event median 527.98 us vs 706.06 us, 1.34x faster | same-backend selector-review captures under `temp/rank47-tree-crt-20260606/`; schema v4 valid; required GPU events available; CPU-reference comparison and `result_compare.py --allow-export-selector-diff` confirm matching shape, selected prefix, limb count, signedness, backend, target, and checksum | local Windows `gfx1100` deprioritization evidence for unsigned tree/CRT at 1024; benchmark-only, no README claim, installed cache entry, default route, or Linux/CDNA claim |
| 2026-06-06 | rank 47 Direct-HIP exact-wide prefix20 fixed-export selector A/B | 20260606 | 1024 exact-wide signed/unsigned, 8 limbs | Direct HIP | prefix20 candidate is marginal and stays experimental: signed candidate 18059 us median end-to-end vs default 18790 us, but export-kernel event is slightly slower at 3818.10 us vs 3794.20 us; unsigned candidate 14864 us vs default 15405 us, but export-kernel event is slower at 758.84 us vs 744.00 us | same-backend selector-review captures under `temp/rank47-tree-crt-20260606/`; schema v4 valid; required GPU events available; CPU-reference comparison and `result_compare.py --allow-export-selector-diff` confirm matching fixed-prefix contract, shape, limb count, signedness, backend, target, and checksums | local Windows `gfx1100` experimental selector evidence only; not a durable speedup claim until variance and export-event evidence support it |
