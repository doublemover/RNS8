...
| 2026-06-05 | large-release-validation-4096-budgeted exact-wide gate | 20260605 | 4096 exact-wide signed, 4 limbs | hipBLASLt | 172818 us median end-to-end; 3.69x vs Direct HIP at 637861 us; 658.24x vs CPU reference at 113755000 us; checksum `5508849193854467465` | budgeted release-gate group; CPU, Direct HIP, hipBLASLt, CK, and rocWMMA captures are schema-valid with 3 warmups, 9 repeats, matching checksum, and required GPU events | no cache entry installed; 4096 exact-wide remains release-gate evidence until reviewed-summary/margin closure and cache eligibility are explicit |
| 2026-06-05 | large-release-validation-4096-budgeted exact-wide gate | 20260605 | 4096 exact-wide unsigned, 4 limbs | hipBLASLt | 162382 us median end-to-end; 3.78x vs Direct HIP at 614116 us; 649.5x vs CPU reference at 105462000 us; checksum `9643325300233475427` | budgeted release-gate group; CPU, Direct HIP, hipBLASLt, CK, and rocWMMA captures are schema-valid with 3 warmups, 9 repeats, matching checksum, and required GPU events; combined 4096 release-gate report now has 44 completed captures plus 2 historical timeout rows across 9 groups | no cache entry installed; 4096 exact-wide remains release-gate evidence until reviewed-summary/margin closure and cache eligibility are explicit |
