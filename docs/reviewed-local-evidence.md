...
| 2026-06-05 | large-release-validation finite-u8 2048 release review | 20260605 | 2048 ring-256 | rocWMMA | 5011 us median end-to-end; 1.07x vs Direct HIP; CPU reference 16285700 us | release reviewed local matrix; required baselines and promoted GPU events available; default local cache installed | stale hipBLASLt loser lacked required events in the original matrix; focused timing rerun cleared event capture only, not cache promotion |
