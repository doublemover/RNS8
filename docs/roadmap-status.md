...
- Optimized strict `mod 2^64` GPU byte GEMMs, accelerator integration of the
  ...
  smoke against CPU byte-limb and direct-HIP captures; public backend
  integration, reviewed release-speed proof, and any required exhaustive
  512/1024 CPU-oracle dumps remain open.
