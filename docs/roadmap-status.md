...
- Optimized strict `mod 2^64` GPU byte GEMMs, accelerator integration of the
  ...
  tiles, padded carry-heavy tails, ragged two-tile output, a 64x64x64
  full-output release-shaped case, and the `k=32768` accepted / `k=32769`
  rejected boundary, plus ISA-gated WMMA evidence and a 64x64x64 same-seed
  benchmark checksum smoke against CPU byte-limb and direct-HIP captures; public
  backend integration, larger-shape correctness evidence, and release-speed
  proof remain open.
