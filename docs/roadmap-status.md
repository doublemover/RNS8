...
- Optimized strict `mod 2^64` GPU byte GEMMs, accelerator integration of the
  ...
  128x128x128 full-output release-shaped cases, and the `k=32768` accepted /
  `k=32769` rejected boundary, plus ISA-gated WMMA evidence and a 64x64x64
  same-seed benchmark checksum smoke against CPU byte-limb and direct-HIP
  captures; public backend integration, 512/1024 correctness evidence, and
  release-speed proof remain open.
