...
- The first rank-3/rank-49 follow-up now has actual budgeted 4096 evidence
  ...
  timed out under a 300-second budget. Both groups remain blocked by
  `missing_required_baselines`. No 4096 cache entry was installed.
