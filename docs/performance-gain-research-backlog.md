...
This document preserves the long-form research backlog and imported roadmap
notes that used to live in [performance-gain-work-queue.md](performance-gain-work-queue.md).
Use the work queue as the ranked execution control panel; use this file for
background rationale, historical work-item detail, and lower-priority research
context.
