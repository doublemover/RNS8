...
- Explicit finite-ring and finite-field `uint8_t` GEMM APIs for CPU reference
  ...
  export, or strict wrap64 byte-limb backend. Direct HIP now reports and uses
  named reducers for finite moduli 251, 255, and 256; other finite moduli still
  use the generic reciprocal reducer.
...
- Broader optimized finite-field algorithms beyond the direct-HIP 251/255/256
  reducers and the explicit-modulus correctness-grade CPU/direct-HIP finite path.
